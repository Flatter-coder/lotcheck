...
const CACHE_VER = "2026-08-30c";  // + the Scrapfly render asks for RAW HTML instead of format=json, so the structured readers finally get a page on every host whose direct fetch is walled
