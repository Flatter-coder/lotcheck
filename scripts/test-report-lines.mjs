...
console.log("\n-- likeForLikePool + marketCompareLine --");
{
  ...
  check("the canonical is at its current version and seals the basis keys", c.v === 13 && c.marketValue.mk === "Lexus" && c.marketValue.pv === "AB" && c.marketValue.from === "2026-08-03", JSON.stringify(c.marketValue));
...
console.log("\n-- olderYearsLadder + olderYearsLine --");
{
  ...
  check("the canonical is at its current version and seals every rung with its basis", cc.v === 13 && cc.oy && cc.oy.st === "confirmed" && cc.oy.r.length === 3 && cc.oy.r[0].kl === 11223 && cc.oy.r[0].kn === 5 && cc.oy.r[0].rd === 5 && cc.oy.r[0].to === "2026-08-18" && cc.oy.mk === "Lexus" && cc.oy.from === "2026-08-03", JSON.stringify(cc.oy).slice(0, 300));
